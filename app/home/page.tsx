  ...
  return (
    <main>
      ...
      <section className="flex flex-col justify-center items-center ">
        <div className="text-white sm:bg-[url('/bgcol.png')] bg-[url('/home.png')] bg-no-repeat bg-cover shadow-xl sm:w-2/6 border-px border-slate-50 bg-gray-100  rounded-2xl  mx-6 mb-6">
        ...
        <div className=" bg-cover shadow-xl sm:w-2/6 border-px border-slate-50 bg-gray-100  rounded-2xl  mx-6 mb-6">
          <div className=" rounded-2xl px-4 py-6">
            <div className="mb-4">
              ...
              <p className="text-4xl font-semibold text-[#024164]">
                Engineering's Day
              </p>
              <p className="mt-3 sm:mt-1">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam
        ...
        <div className="text-white bg-[url('/bgcol.png')] bg-cover shadow-xl sm:w-2/6 border-px border-slate-50 bg-gray-100  rounded-2xl  mx-6 mb-6">
          <div className="bg-sky-950/90 backdrop-brightness-75 rounded-2xl px-4 py-6">
            <div className="mb-4">
              <div className=" flex justify-between items-center max-sm:hidden">
                <div className="border-[1px] w-fit px-4 py-0.5 rounded-2xl border-gray-300">
