...
export default function evaluate() {
  return (
    <main className='md:mx-[3%]'>
      ...
      <div className="w-screen xl:w-[70%] p-6 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-16 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div>
        <p className='text-2xl font-semibold max-md:text-center'>Evaluation</p>
        <div className='grid grid-cols-4 gap-2 text-sm sm:text-lg text-white text-center'>
            <p className='bg-[#014164] py-2 w-[70px] md:w-20'>Superior</p>
            <p className='bg-[#014164] py-2 md:w-20'>Excellent</p>
            <p className='bg-[#014164] py-2 md:w-20'>Good</p>
          ...
          <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number9" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  <input type="radio" id="number8" name="hosting" value="8" className="hidden peer" required />
                  <label htmlFor="number8" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number7" name="hosting" value="7" className="hidden peer" required />
                  <label htmlFor="number7" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number6" name="hosting" value="6" className="hidden peer" required />
                  <label htmlFor="number6" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number5" name="hosting" value="5" className="hidden peer" required />
                  <label htmlFor="number5" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  <input type="radio" id="number4" name="hosting" value="4" className="hidden peer" required />
                  <label htmlFor="number4" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number19" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  <input type="radio" id="number18" name="hosting2" value="8" className="hidden peer" required />
                  <label htmlFor="number18" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number17" name="hosting2" value="7" className="hidden peer" required />
                  <label htmlFor="number17" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  ...
                  <label htmlFor="number15" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  <input type="radio" id="number14" name="hosting2" value="4" className="hidden peer" required />
                  <label htmlFor="number14" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
                  <input type="radio" id="number13" name="hosting2" value="3" className="hidden peer" required />
                  <label htmlFor="number13" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number28" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number27" name="hosting3" value="7" className="hidden peer" required />
                  <label htmlFor="number27" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number26" name="hosting3" value="6" className="hidden peer" required />
                  <label htmlFor="number26" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number25" name="hosting3" value="5" className="hidden peer" required />
                  <label htmlFor="number25" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  <input type="radio" id="number24" name="hosting3" value="4" className="hidden peer" required />
                  <label htmlFor="number24" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
                  <input type="radio" id="number23" name="hosting3" value="3" className="hidden peer" required />
                  <label htmlFor="number23" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number39" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  <input type="radio" id="number38" name="hosting4" value="8" className="hidden peer" required />
                  <label htmlFor="number38" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number37" name="hosting4" value="7" className="hidden peer" required />
                  <label htmlFor="number37" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number36" name="hosting4" value="6" className="hidden peer" required />
                  <label htmlFor="number36" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number35" name="hosting4" value="5" className="hidden peer" required />
                  <label htmlFor="number35" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  ...
                  <label htmlFor="number33" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number49" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  ...
                  <label htmlFor="number47" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number46" name="hosting5" value="6" className="hidden peer" required />
                  <label htmlFor="number46" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number45" name="hosting5" value="5" className="hidden peer" required />
                  <label htmlFor="number45" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  <input type="radio" id="number44" name="hosting5" value="4" className="hidden peer" required />
                  <label htmlFor="number44" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
                  <input type="radio" id="number43" name="hosting5" value="3" className="hidden peer" required />
                  <label htmlFor="number43" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number59" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  ...
                  <label htmlFor="number57" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number56" name="hosting6" value="6" className="hidden peer" required />
                  <label htmlFor="number56" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number55" name="hosting6" value="5" className="hidden peer" required />
                  <label htmlFor="number55" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  ...
                  <label htmlFor="number53" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
              </ul>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number69" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  <input type="radio" id="number68" name="hosting7" value="8" className="hidden peer" required />
                  <label htmlFor="number68" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number67" name="hosting7" value="7" className="hidden peer" required />
                  <label htmlFor="number67" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number66" name="hosting7" value="6" className="hidden peer" required />
                  <label htmlFor="number66" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number65" name="hosting7" value="5" className="hidden peer" required />
                  <label htmlFor="number65" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  <input type="radio" id="number64" name="hosting7" value="4" className="hidden peer" required />
                  <label htmlFor="number64" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
                  <input type="radio" id="number63" name="hosting7" value="3" className="hidden peer" required />
                  <label htmlFor="number63" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number79" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  <input type="radio" id="number78" name="hosting8" value="8" className="hidden peer" required />
                  <label htmlFor="number78" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number77" name="hosting8" value="7" className="hidden peer" required />
                  <label htmlFor="number77" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number76" name="hosting8" value="6" className="hidden peer" required />
                  <label htmlFor="number76" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  ...
                  <label htmlFor="number74" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
                  <input type="radio" id="number73" name="hosting8" value="3" className="hidden peer" required />
                  <label htmlFor="number73" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
            ...
            <div className='md:w-1/2'>
              ...
              <ul className="flex items-center gap-1 md:gap-2 justify-center mt-4 md:mt-0 mb-4 md:mb-0">
                ...
                <li>
                  ...
                  <label htmlFor="number89" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    9
                  </label>
                </li><li>
                  <input type="radio" id="number88" name="hosting9" value="8" className="hidden peer" required />
                  <label htmlFor="number88" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    8
                  </label>
                </li><li>
                  <input type="radio" id="number87" name="hosting9" value="7" className="hidden peer" required />
                  <label htmlFor="number87" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    7
                  </label>
                </li><li>
                  <input type="radio" id="number86" name="hosting9" value="6" className="hidden peer" required />
                  <label htmlFor="number86" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    6
                  </label>
                </li><li>
                  <input type="radio" id="number85" name="hosting9" value="5" className="hidden peer" required />
                  <label htmlFor="number85" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    5
                  </label>
                </li><li>
                  <input type="radio" id="number84" name="hosting9" value="4" className="hidden peer" required />
                  <label htmlFor="number84" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    4
                  </label>
                </li><li>
                  <input type="radio" id="number83" name="hosting9" value="3" className="hidden peer" required />
                  <label htmlFor="number83" className="py-2 px-3 sm:py-4 sm:px-5 md:py-3 md:px-4 text-gray-900 bg-white peer-checked:bg-[#014164] peer-checked:text-white border border-gray-500 rounded-full cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 hover:text-white hover:bg-[#014164] dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    3
                  </label>
                </li>
              </ul>
